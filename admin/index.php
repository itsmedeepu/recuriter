...
if(isset($_POST['submit'])) {
    ...
    if (empty($captcha) || $captcha != $_SESSION['captcha'] && $token!=$_SESSION['token']) {
        echo "<script>alert('captcha code wrong are session exxpired');</script>";
    } else {

        $q = "select * from admin where EMAIL='$email' && PASSWORD='$pass' && SECRETKEY='$key'";
...
<head>
    ...
    <link rel="stylesheet" href="../assets1/bootstrap/css/bootstrap.css">
            ...
            <div class="col-md-12">
                            ...
                            <div class="panel panel-success" >
                                ...
                                <div class="panel-body">
                                    <form method="post">
                                        ...
                                        <div class="form-group">
                                            <img src="../assets/captcha/captcha.php" id="captcha_img">&nbsp;&nbsp;<span><img id="refresh" src="../assets1/re.png" width="30px" height="30px"></span>
                                        </div>
                ...
                <div class="row">
                    <div class="col-md-12" style="background:#2a2730;margin:0px;padding:10px;box-shadow:0px 0px 10px 0px #888888;">
                        <div class="row">
                            <div class="col-md-12" style="text-align:center;color:white;padding-left:20px;"> © by 2021</div>
                        </div>
                    </div>
                </div>
